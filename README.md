<p align="center">
  <img src="assets/icon.png" width="120" height="120" style="border-radius: 22px;" alt="Monologue Icon" />
</p>
...
```bash
git clone https://github.com/Lincb522/Monologue-music.git
cd Monologue-music
```
...
Xcode 打开 `Monologue.xcodeproj`，SPM 会自动拉取远程依赖，编译运行即可。
...
脚本以 `CODE_SIGNING_ALLOWED=NO` 编译 Release 版本并打包生成 `Monologue.ipa`，可通过 TrollStore 安装。
...
| 项目 | 说明 |
|---|---|
| [NeteaseCloudMusicApi Enhanced](https://github.com/NeteaseCloudMusicApiEnhanced/api-enhanced) | ncm API |
| [QQMusicApi](https://github.com/L-1124/QQMusicApi) | qcm API |
