...
final class PlaybackPersistence {
    ...
    private func buildPlayerState() -> PlayerManager.PlayerState {
        ...
        return PlayerManager.PlayerState(
            ...
            lastPlaybackInput: player.currentSong == nil ? nil : player.currentPlayingURL,
            lastPlaybackInputResolvedAt: player.currentSong == nil ? nil : player.playbackURLResolvedAt,
            lastPlaybackDecryptionKey: player.currentSong == nil ? nil : player.currentPlayingDecryptionKey
        )
    }
