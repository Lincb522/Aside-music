...
struct CapsulePodcastExperience: View {
    ...
    private func dockChip(title: String, value: String, icon: MonologueIcon.IconType, tint: Color) -> some View {
    ...
    private func categoryChip(_ category: RadioCategory) -> some View {
        HStack(spacing: 8) {
            MonologueIcon(icon: category.monologueIconType, size: 15, color: CapsuleStyle.violet, lineWidth: 1.7)
                ...
                capsuleCover(url: radio.coverUrl, size: CGSize(width: 138, height: 112), cornerRadius: 28, tint: tint)
                    .overlay(alignment: .bottomTrailing) {
                        Button {
                            ...
                            MonologueIcon(icon: .play, size: 13, color: CapsuleStyle.readableLabel(on: tint), lineWidth: 1.8)
    ...
    private func radioStripe(radio: RadioStation, index: Int, tint: Color) -> some View {
        NavigationLink(value: PodcastView.PodcastDestination.radioDetail(radio.id)) {
            HStack(spacing: 12) {
                ...
                MonologueIcon(icon: .chevronRight, size: 13, color: CapsuleStyle.inkMuted, lineWidth: 1.7)
            }
            .padding(10)
    ...
    private func programRankStripe(program: PodcastCreative, index: Int, tint: Color) -> some View {
        Button {
            ...
            HStack(spacing: 12) {
                ...
                MonologueIcon(icon: .play, size: 13, color: CapsuleStyle.inkSoft, lineWidth: 1.7)
                    .frame(width: 32, height: 32)
    ...
    private func capsuleCover(url: URL?, size: CGSize, cornerRadius: CGFloat, tint: Color) -> some View {
        CachedAsyncImage(url: url, width: size.width, height: size.height) {
            ZStack {
                ...
                MonologueIcon(icon: .podcast, size: min(size.width, size.height) * 0.34, color: tint.opacity(0.7), lineWidth: 1.8)
            }
        }
