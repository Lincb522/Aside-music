...
struct AIEqualizerLabView: View {
                    ...
                    if agent.learningEvidenceCount > 0 {
                        ...
                        Button {
                            ...
                            HStack(spacing: 12) {
                                ...
                                MonologueIcon(icon: .trash, size: 13, color: .white.opacity(0.42))
                            }
                            .padding(.horizontal, 14)
                            .frame(minHeight: 46)
                            .contentShape(Rectangle())
    ...
    private var analysisNotice: some View {
        HStack(alignment: .top, spacing: 10) {
            MonologueIcon(icon: .infoCircle, size: 14, color: accent)
                    ...
                    Button {
                        ...
                        HStack(spacing: 6) {
                            Text(String(localized: "ai_lab_view_full_comparison"))
                                .font(.system(size: 12, weight: .bold))
                            MonologueIcon(icon: .chevronRight, size: 10, color: accent)
                        }
                        .foregroundStyle(accent)
                    }
                    .buttonStyle(.plain)
        ...
        return VStack(alignment: .leading, spacing: 9) {
            ...
            HStack(spacing: 7) {
                ...
                Button {
                    ...
                    MonologueIcon(icon: .play, size: 13, color: canApply ? .white.opacity(0.86) : .white.opacity(0.28))
                ...
                Button(role: .destructive) {
                    ...
                    MonologueIcon(icon: .trash, size: 13, color: .red.opacity(0.84))
                        .frame(width: 30, height: 30)
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    if let current, current.id != historical.id {
                        ...
                        HStack(spacing: 10) {
                            MonologueIcon(icon: .infoCircle, size: 16, color: accent)
        ...
        .toolbar {
            ToolbarItem(placement: .topBarLeading) {
                Button { dismiss() } label: {
                    MonologueIcon(icon: .close, size: 13, color: .white.opacity(0.82))
