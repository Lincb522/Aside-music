...
struct MonoSuiteSettingsView: View {
    ...
    private var currentCoverPlaceholder: some View {
        RoundedRectangle(cornerRadius: 13, style: .continuous)
            ...
            .overlay {
                MonologueIcon(icon: .musicNote, size: 23, color: .white.opacity(0.42))
            }
    }
    ...
    private var recoveryControls: some View {
        VStack(alignment: .leading, spacing: 13) {
            Button {
                ...
                HStack(spacing: 12) {
                    MonologueIcon(icon: .history, size: 18, color: accent)
                    ...
                    MonologueIcon(icon: .chevronRight, size: 13, color: .white.opacity(0.42))
                }
    ...
    private func compactEmptyState(icon: MonologueIcon.IconType, text: String) -> some View {
        HStack(spacing: 11) {
            MonologueIcon(icon: icon, size: 17, color: accent)
...
private struct MonoRecoveryHistoryView: View {
    ...
    private var emptyState: some View {
        VStack(spacing: 12) {
            MonologueIcon(icon: .history, size: 24, color: accent)
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            ZStack {
                ...
                MonologueIcon(icon: .headphones, size: 19, color: .white.opacity(0.72))
