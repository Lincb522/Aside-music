...
struct ListeningStatsView: View {
        ...
        .toolbar {
            ToolbarItem(placement: .topBarTrailing) {
                Button {
                    ...
                    MonologueIcon(icon: .more, size: 17, color: .monologueTextSecondary)
    ...
    private var listeningStatsMoreMenu: some View {
        VStack(alignment: .leading, spacing: 16) {
            MonologueMoreMenuSection(title: String(localized: "more_menu_reports_section")) {
            ...
            MonologueMoreMenuSection(title: String(localized: "more_menu_data_section")) {
                MonologueMoreMenuGroup {
                ...
                Text(summary.durationText ?? "—")
                    ...
                    .foregroundStyle(
                        summary.durationText == nil
                            ? Color.monologueTextSecondary.opacity(0.45)
                    ...
                    Button {
                        ...
                        Text(period.rawValue)
                            ...
                            .foregroundStyle(
                                selected
                                    ? Color.monologueTextPrimary
                                    : Color.monologueTextSecondary.opacity(0.8)
                            )
                            ...
                            .background(
                                Capsule().fill(
                                    selected
                                        ? Color.monologueTextPrimary.opacity(0.08)
                                        : Color.clear
                                )
                            )
                            .overlay(
                                Capsule().stroke(
                                    selected
                                        ...
                                        : Color.monologueTextPrimary.opacity(0.05),
                                    lineWidth: 1
                                )
                            )
                    }
            ...
            if let change = stats.percentChange, let label = selectedPeriod.comparisonLabel {
                ...
                .background(
                    Capsule()
                        ...
                        .overlay(Capsule().stroke(Color.monologueAccent.opacity(0.24), lineWidth: 0.8))
                )
                .padding(.top, 2)
            }
    ...
    private var compactTrendAxis: some View {
        ...
        .monospacedDigit()
        .foregroundStyle(Color.monologueTextSecondary.opacity(0.65))
    }
    ...
    private func topArtistRow(artist: ListeningStatsService.ArtistStat, rank: Int) -> some View {
        HStack(spacing: 12) {
            ...
            .clipShape(Circle())
            .overlay(
                Circle().stroke(Color.monologueTextPrimary.opacity(0.07), lineWidth: 1)
            )
    ...
    private func statsTrackBar(
        ...
        return ZStack(alignment: .bottom) {
            ...
            if value > 0 {
                RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
                    .fill(isHighlighted ? Color.monologueAccent : Color.monologueTextPrimary.opacity(0.26))
