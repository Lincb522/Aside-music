...
struct MonoSessionPlayerView: View {
    ...
    private func topBar(horizontalInset: CGFloat) -> some View {
        HStack(spacing: 12) {
            Button {
                ...
                MonologueIcon(icon: .chevronLeft, size: 16, color: .white)
            ...
            if let room = session.room {
                ShareLink(item: room.inviteCode) {
                    MonologueIcon(icon: .share, size: 16, color: .white)
                        .frame(width: 42, height: 42)
                        .background(
                            RoundedRectangle(cornerRadius: 13, style: .continuous)
                                .fill(Color.white.opacity(0.1))
                ...
                Button {
                    ...
                    MonologueIcon(icon: .close, size: 15, color: .white.opacity(0.66))
                        .frame(width: 42, height: 42)
                        .background(
                            RoundedRectangle(cornerRadius: 13, style: .continuous)
            ...
            VStack(spacing: 26) {
                    ...
                    Button {
                        ...
                        HStack(spacing: 9) {
                            if isConnecting {
                                ...
                                MonologueIcon(icon: .headphones, size: 17, color: accentControlForeground)
                            }
                ...
                .background(
                    RoundedRectangle(cornerRadius: 16, style: .continuous)
                        .fill(Color.monologueTextPrimary.opacity(0.045))
                )
                .overlay {
                    RoundedRectangle(cornerRadius: 16, style: .continuous)
                        .stroke(Color.monologueSeparator.opacity(0.65), lineWidth: 0.5)
                }
            }
            .padding(.bottom, 40)
        }
    ...
    private func coverPlaceholder(size: CGFloat) -> some View {
        RoundedRectangle(cornerRadius: 16, style: .continuous)
            ...
            .frame(width: size, height: size)
            .overlay {
                MonologueIcon(icon: .musicNote, size: min(36, size * 0.17), color: .monologueTextSecondary)
            }
    }
    ...
    private func controlButton(
        ...
        Button(action: action) {
            MonologueIcon(icon: icon, size: size, color: .monologueTextPrimary)
    ...
    private var queueSearchPanel: some View {
        VStack(spacing: 10) {
            HStack(spacing: 9) {
                MonologueIcon(icon: .search, size: 14, color: .white.opacity(0.46))
    ...
    private func sessionSongRow(
        _ song: Song,
        leadingText: String?,
        trailingIcon: MonologueIcon.IconType?,
        trailingColor: Color,
        ...
        HStack(spacing: 10) {
            ...
            if showsLoading {
                ...
                MonologueIcon(icon: trailingIcon, size: 13, color: trailingColor)
                    .frame(width: 30, height: 30)
    ...
    private var chatPanel: some View {
        VStack(spacing: 0) {
            ...
            Rectangle()
                .fill(Color.monologueSeparator.opacity(0.65))
                .frame(height: 0.5)
    ...
    private func chatBubble(_ message: MonoSessionChatMessage) -> some View {
        ...
        return HStack {
            ...
            VStack(alignment: mine ? .trailing : .leading, spacing: 4) {
                ...
                Text(message.text)
                    .font(.system(size: 13.5, weight: .medium, design: .rounded))
                    .foregroundStyle(mine ? accentControlForeground : Color.monologueTextPrimary)
                    .multilineTextAlignment(mine ? .trailing : .leading)
                    .padding(.horizontal, 12)
                    .padding(.vertical, 9)
                    .background(
                        RoundedRectangle(cornerRadius: 13, style: .continuous)
                            .fill(mine ? accentControlFill : Color.monologueTextPrimary.opacity(0.07))
                    )
            }
    ...
    private var chatComposer: some View {
        HStack(spacing: 9) {
            ...
            Button(action: sendChat) {
                MonologueIcon(icon: .send, size: 16, color: accentControlForeground)
    ...
    private func performRoomSearch() {
        let keyword = roomSearchQuery.trimmingCharacters(in: .whitespacesAndNewlines)
