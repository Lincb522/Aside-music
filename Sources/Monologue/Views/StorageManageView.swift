...
struct StorageManageView: View {
        ...
        Button {
            ...
            HStack(spacing: 12) {
                ZStack {
                    ...
                    MonologueIcon(icon: .trash, size: 18, color: StorageTheme.destructive)
                }
                ...
                MonologueIcon(icon: .chevronRight, size: 13, color: StorageTheme.destructive.opacity(0.7))
            }
            .padding(16)
    ...
    private func refreshCategory(_ id: String) {
        Task { @MainActor in
            ...
            case "apiCache":
                size = await Task.detached { StoragePaths.recursiveSize(at: StoragePaths.monologueCache) }.value
            case "imageCache":
    ...
    var body: some View {
        ZStack {
            ...
            Circle()
                ...
                .stroke(
                    AngularGradient(
                        colors: [Color.monologueAccent.opacity(0), Color.monologueAccent],
                        center: .center,
...
private enum StoragePaths {
    ...
    static var monologueCache: URL {
        let base = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first
            ?? FileManager.default.temporaryDirectory
        return base.appendingPathComponent("MonologueCache")
    }
    ...
    static func databaseSize() -> Int64 {
        ...
        var total: Int64 = 0
        for name in ["default.store", "MonologueLocal.sqlite"] {
