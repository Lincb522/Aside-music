...
struct PlayerMoreMenu: View {
    ...
    private var immersiveMenuRow: some View {
        HStack(spacing: 0) {
            ...
            Rectangle()
                .fill(Color.monologueSeparator.opacity(0.8))
            ...
            Button {
                ...
                MonologueIcon(icon: .settings, size: 15, color: textColor.opacity(0.72))
    ...
    private var menuDivider: some View {
        Rectangle()
            .fill(Color.monologueSeparator.opacity(0.72))
            .frame(height: 0.5)
            .padding(.leading, 47)
    }
    ...
    private func menuGroup<Content: View>(
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .stroke(Color.monologueSeparator.opacity(0.52), lineWidth: 0.5)
        }
