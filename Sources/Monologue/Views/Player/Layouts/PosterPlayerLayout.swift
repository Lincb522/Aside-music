    ...
    private var controlStrip: some View {
        HStack {
            ...
            Button(action: { player.switchMode() }) {
                MonologueIcon(icon: player.mode.monologueIcon, size: 22, color: fg)
            ...
            Button(action: { player.previous() }) {
                MonologueIcon(icon: .previous, size: 24, color: fg)
                    .frame(width: 44, height: 44)
                    .contentShape(Rectangle())
            }
            .buttonStyle(MonologueBouncingButtonStyle())
            ...
            Button(action: { player.next() }) {
                MonologueIcon(icon: .next, size: 24, color: fg)
                    .frame(width: 44, height: 44)
                    .contentShape(Rectangle())
            }
            .buttonStyle(MonologueBouncingButtonStyle())
            ...
            Button(action: { showPlaylist = true }) {
                MonologueIcon(icon: .list, size: 22, color: fg)
                    .frame(width: 44, height: 44)
                    .contentShape(Rectangle())
            }
            .buttonStyle(MonologueBouncingButtonStyle())
