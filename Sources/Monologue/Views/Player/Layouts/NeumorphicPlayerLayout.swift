...
struct NeumorphicPlayerLayout: View {
    ...
    private var textColor: Color { .monologueTextPrimary }
    private var secondaryTextColor: Color { .monologueTextSecondary }
    
    private var neuBg: Color {
        colorScheme == .dark ? Color(hex: "1A1A1E") : Color(hex: "E8E8ED")
    }
...
extension NeumorphicPlayerLayout {
    ...
    private var headerBar: some View {
        HStack {
            neumorphicButton(size: 44) {
                ...
                MonologueIcon(icon: .chevronRight, size: 20, color: secondaryTextColor)
            ...
            neumorphicButton(size: 44) {
                ...
                MonologueIcon(icon: .more, size: 22, color: secondaryTextColor)
            }
        }
            ...
            if let song = player.currentSong {
                ZStack {
                    ...
                    if let dynamicUrl = player.dynamicCoverUrl, !dynamicUrl.isEmpty {
                        DynamicCoverView(urlString: dynamicUrl, cornerRadius: 20)
                    }
                }
                ...
                RoundedRectangle(cornerRadius: 20)
                    ...
                    .frame(width: size, height: size)
                    .overlay(
                        MonologueIcon(icon: .musicNote, size: 60, color: secondaryTextColor)
                    )
            }
        }
    }
    ...
    private var controlsSection: some View {
        HStack(spacing: 0) {
            neumorphicButton(size: 44) {
                ...
                MonologueIcon(icon: player.mode.monologueIcon, size: 20, color: secondaryTextColor)
            }
            ...
            neumorphicButton(size: 56) {
                ...
                MonologueIcon(icon: .previous, size: 26, color: textColor)
            }
            ...
            neumorphicButton(size: 56) {
                ...
                MonologueIcon(icon: .next, size: 26, color: textColor)
            }
            ...
            neumorphicButton(size: 44) {
                ...
                MonologueIcon(icon: .list, size: 20, color: secondaryTextColor)
            }
        }
    }
        ...
        Button(action: { player.togglePlayPause() }) {
            ZStack {
                ...
                if player.isLoading {
                    ...
                    MonologueIcon(icon: player.isPlaying ? .pause : .play, size: 30, color: textColor)
                }
            }
        }
    ...
    private var additionalButtons: some View {
        HStack(spacing: 0) {
            if let song = player.currentSong {
                LikeButton(songId: song.id, isQQMusic: song.isQQMusic, song: song, size: 22, activeColor: .red, inactiveColor: secondaryTextColor)
                    .frame(width: 44)
            } else {
            ...
            neumorphicButton(size: 40) {
                ...
                MonologueIcon(icon: .comment, size: 18, color: secondaryTextColor, lineWidth: 1.4)
            }
