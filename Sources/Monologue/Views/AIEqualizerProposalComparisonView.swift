//
//  AIEqualizerProposalComparisonView.swift
//  Monologue
//
    ...
    private var pageHeader: some View {
        HStack(spacing: 12) {
            Button { dismiss() } label: {
                MonologueIcon(icon: .close, size: 13, color: .white.opacity(0.88))
    ...
    private func proposalHero(
        ...
        HStack(spacing: 10) {
            ...
            ZStack {
                ...
                MonologueIcon(icon: .chevronRight, size: 10, color: .white.opacity(0.48))
            }
        ...
        return VStack(spacing: 0) {
            Button {
                ...
                HStack(spacing: 10) {
                    ...
                    MonologueIcon(icon: .chevronRight, size: 10, color: .white.opacity(0.42))
    ...
    private func bandCell(
        ...
        return VStack(alignment: .leading, spacing: 7) {
            ...
            HStack(spacing: 5) {
                ...
                MonologueIcon(icon: .chevronRight, size: 7, color: .white.opacity(0.24))
