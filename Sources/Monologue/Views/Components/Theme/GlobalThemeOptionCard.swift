...
struct GlobalThemeOptionCard: View {
                    ...
                    RoundedRectangle(cornerRadius: 18, style: .continuous)
                        .stroke(
                            isSelected
                                ...
                                : Color.monologueSeparator.opacity(0.45),
    ...
    private func miniPlayerChip<Cover: View, Chrome: View>(
        ...
        HStack(spacing: 8) {
            ...
            Circle()
                ...
                .overlay(
                    MonologueIcon(icon: .play, size: 7.5, color: playForeground, lineWidth: 1.7)
                        .offset(x: 0.5)
                )
        }
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                miniPlayerChip(
                    cover: RoundedRectangle(cornerRadius: 6, style: .continuous)
                        ...
                        .overlay(
                            MonologueIcon(icon: .musicNote, size: 11, color: MinimalWhiteStyle.ink, lineWidth: 1.5)
                        ),
                    coverRadius: 6,
    ...
    private var mangaPoster: some View {
        ZStack {
            MangaStyle.paper
            MangaDotsTexture(opacity: 0.06, gap: 10)
            ...
            VStack(alignment: .leading, spacing: 0) {
                HStack(spacing: 6) {
                    ...
                    paletteDots(
                        [MangaStyle.labelYellow, MangaStyle.accentPink, MangaStyle.strokeInk],
                        ring: MangaStyle.strokeInk.opacity(0.6)
                    )
                }
                ...
                Text(themeId.displayName)
                    ...
                    .shadow(color: MangaStyle.labelYellow, radius: 0, x: 2, y: 2)
                    .lineLimit(1)
                    .minimumScaleFactor(0.7)
                    .padding(.top, 8)
                ...
                HStack(spacing: 3) {
                    ForEach(0 ..< 3, id: \.self) { index in
                        Rectangle()
                            .fill(MangaStyle.strokeInk.opacity(0.75))
                            .frame(width: CGFloat(22 - index * 7), height: 1.6)
                    }
                }
                .padding(.top, 8)
                ...
                miniPlayerChip(
                    cover: RoundedRectangle(cornerRadius: 5, style: .continuous)
                        .fill(MangaStyle.labelYellow.opacity(0.6))
                        .overlay(
                            RoundedRectangle(cornerRadius: 5, style: .continuous)
                                .stroke(MangaStyle.strokeInk, lineWidth: 1.3)
                        ),
                    coverRadius: 5,
                    titleFont: MangaStyle.comicFont(9.5, weight: .black),
                    artistFont: MangaStyle.comicFont(7.5, weight: .bold),
                    titleColor: MangaStyle.strokeInk,
                    artistColor: MangaStyle.strokeInk.opacity(0.55),
                    ...
                    background: RoundedRectangle(cornerRadius: 9, style: .continuous)
                        ...
                        .shadow(color: MangaStyle.strokeInk.opacity(0.6), radius: 0, x: 2.5, y: 2.5)
                )
            }
            .padding(12)
        }
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                miniPlayerChip(
                    cover: RoundedRectangle(cornerRadius: 8, style: .continuous)
                        ...
                        .overlay(
                            MonologueIcon(icon: .musicNote, size: 10, color: accent.opacity(0.85), lineWidth: 1.5)
                        ),
                    coverRadius: 8,
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                miniPlayerChip(
                    cover: RoundedRectangle(cornerRadius: 12, style: .continuous)
                        ...
                        .overlay(
                            MonologueIcon(icon: .waveform, size: 11, color: .white, lineWidth: 1.5)
                        ),
                    coverRadius: 12,
