...
struct MonologueBouncingButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        configuration.label
            ...
            .animation(MonologueAnimation.buttonPress, value: effectivePressed)
...
extension View {
    func monologueBouncing() -> some View {
        self.buttonStyle(MonologueBouncingButtonStyle())
    }
