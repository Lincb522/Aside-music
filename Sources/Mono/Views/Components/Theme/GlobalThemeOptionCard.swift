    ...
    private var consolePoster: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                miniPlayerChip(
                    cover: RoundedRectangle(cornerRadius: SignalStyle.compactRadius, style: .continuous)
                    ...
                    coverRadius: SignalStyle.compactRadius,
                    ...
                    background: RoundedRectangle(cornerRadius: SignalStyle.cardRadius, style: .continuous)
