        ...
        return Button {
            ...
            VStack(alignment: .leading, spacing: 11) {
                HStack(spacing: 12) {
                    ...
                    Circle()
                        .stroke(
                            isSelected ? accent : Color.monoSeparator.opacity(0.9),
    ...
    private func cardBackground(isSelected: Bool) -> some View {
        if NeumorphicStyle.isActive {
            ...
            RoundedRectangle(cornerRadius: panelCornerRadius, style: .continuous)
                .fill(isSelected ? accent.opacity(0.055) : Color.monoGlassTint)
                .monoGlass(cornerRadius: panelCornerRadius + 4)
                .overlay(
                    RoundedRectangle(cornerRadius: panelCornerRadius, style: .continuous)
                        .stroke(
                            isSelected ? accent.opacity(0.42) : Color.monoSeparator.opacity(0.4),
