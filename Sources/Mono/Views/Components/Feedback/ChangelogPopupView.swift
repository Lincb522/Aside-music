...
private struct ChangelogPopupCard: View {
    ...
    private var header: some View {
        ZStack(alignment: .topLeading) {
            ...
            LinearGradient(
                colors: [
                    Color.monoAccent.opacity(colorScheme == .dark ? 0.34 : 0.2),
                    Color.monoAccent.opacity(0.0),
                ],
                startPoint: .top,
                endPoint: .bottom
            )
            ...
            VStack(alignment: .leading, spacing: 12) {
                HStack(alignment: .top) {
                    HStack(spacing: 5) {
                        MonoIcon(icon: .sparkle, size: 11, color: .monoAccent)
                    ...
                    .background(
                        Capsule()
                            ...
                            .overlay(
                                Capsule().stroke(Color.monoAccent.opacity(0.3), lineWidth: 0.8)
                            )
                    )
                    ...
                    .buttonStyle(MonoBouncingButtonStyle(scale: 0.88))
                }
                ...
                ForEach(Array(section.items.enumerated()), id: \.offset) { _, item in
                    HStack(alignment: .top, spacing: 9) {
                        ...
                        Text(item)
                            ...
                            .foregroundColor(.monoTextPrimary.opacity(0.84))
                            .lineSpacing(3.5)
