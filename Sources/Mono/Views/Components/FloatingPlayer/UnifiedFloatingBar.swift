    ...
    var body: some View {
        VStack(spacing: 3) {
            ...
            MangaDedicatedTabBar(currentTab: $currentTab)
                ...
                .simultaneousGesture(tabSwipeGesture)
                .overlay(alignment: .topTrailing) {
                    MangaSFXNote(size: 20, rotation: 15)
                        .offset(x: -12, y: -13)
...
private struct MangaMiniPlayerStrip: View {
    ...
    private func mangaSourceIndicator(icon: MonoIcon.IconType) -> some View {
        MonoIcon(icon: icon, size: 10, color: MangaComicPalette.whiteInk, lineWidth: 1.5)
            .frame(width: 18, height: 18)
