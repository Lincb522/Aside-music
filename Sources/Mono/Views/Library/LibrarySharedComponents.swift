...
struct LibraryInlineLoadingView: View {
    ...
    var body: some View {
        MonoLoadingView(text: text, centered: false)
            .frame(maxWidth: .infinity)
            .padding(.vertical, 14)
    }
}
    ...
    var body: some View {
        VStack(spacing: 12) {
            if PetWhiteStyle.isActive {
                ...
                MonoIcon(icon: icon, size: 28, color: tint.opacity(0.72), lineWidth: 1.8)
            }
            Text(title)
        ...
        HStack(spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 5) {
                Text(radio.name)
                    ...
                    .foregroundColor(PetWhiteStyle.isActive ? PetWhiteStyle.ink : (NeumorphicStyle.isActive ? NeumorphicStyle.ink : (MujiStyle.isActive ? MujiStyle.ink : (SequoiaStyle.isActive ? SequoiaStyle.ink : .monoTextPrimary))))
                    .lineLimit(1)
                ...
                Text(radio.dj?.nickname ?? radio.category ?? "Podcast")
                    ...
                    .foregroundColor(PetWhiteStyle.isActive ? PetWhiteStyle.inkSoft : (NeumorphicStyle.isActive ? NeumorphicStyle.inkMuted : (MujiStyle.isActive ? MujiStyle.inkSoft : (SequoiaStyle.isActive ? SequoiaStyle.inkSoft : .monoTextSecondary))))
                    .lineLimit(1)
            }
            ...
            if PetWhiteStyle.isActive {
                ...
                MonoIcon(icon: .chevronRight, size: 12, color: tint.opacity(0.72), lineWidth: 1.8)
            }
        }
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text(artist.name)
                ...
                .foregroundColor(PetWhiteStyle.isActive ? PetWhiteStyle.ink : (NeumorphicStyle.isActive ? NeumorphicStyle.ink : (MujiStyle.isActive ? MujiStyle.ink : (SequoiaStyle.isActive ? SequoiaStyle.ink : (CapsuleStyle.isActive ? CapsuleStyle.ink : .monoTextPrimary)))))
                .lineLimit(1)
        }
        ...
        HStack(spacing: 11) {
            CachedAsyncImage(url: playlist.coverUrl?.sized(400)) {
                RoundedRectangle(cornerRadius: 14, style: .continuous)
                    ...
                    .overlay(
                        MonoIcon(icon: .musicNoteList, size: 20, color: tint.opacity(0.62), lineWidth: 1.55)
                    )
            }
            .aspectRatio(contentMode: .fill)
            ...
            ZStack(alignment: .bottomTrailing) {
                CachedAsyncImage(url: playlist.coverUrl?.sized(600)) {
                    RoundedRectangle(cornerRadius: 18, style: .continuous)
                        ...
                        .overlay(
                            MonoIcon(icon: .musicNoteList, size: 24, color: NeumorphicStyle.inkMuted.opacity(0.55), lineWidth: 1.7)
                        )
                }
                ...
                MonoIcon(icon: .play, size: 12, color: Color(light: .white, dark: .black), lineWidth: 1.8)
        ...
        HStack(spacing: 13) {
            CachedAsyncImage(url: playlist.coverUrl?.sized(260)) {
                RoundedRectangle(cornerRadius: 17, style: .continuous)
                    .fill(NeumorphicStyle.surfacePressed)
                    .overlay(MonoIcon(icon: .list, size: 22, color: NeumorphicStyle.inkMuted.opacity(0.6), lineWidth: 1.7))
            }
            .aspectRatio(contentMode: .fill)
            .frame(width: 56, height: 56)
            .clipShape(RoundedRectangle(cornerRadius: 17, style: .continuous))
    ...
    var body: some View {
        HStack(spacing: 13) {
            CachedAsyncImage(url: radio.coverUrl) {
                RoundedRectangle(cornerRadius: 17, style: .continuous)
                    .fill(NeumorphicStyle.surfacePressed)
                    .overlay(MonoIcon(icon: .radio, size: 22, color: NeumorphicStyle.inkMuted.opacity(0.6), lineWidth: 1.7))
            }
            .aspectRatio(contentMode: .fill)
            .frame(width: 56, height: 56)
            .clipShape(RoundedRectangle(cornerRadius: 17, style: .continuous))
        ...
        VStack(alignment: .leading, spacing: 10) {
            ZStack(alignment: .bottomTrailing) {
                CachedAsyncImage(url: playlist.coverUrl?.sized(500)) {
                    RoundedRectangle(cornerRadius: 18, style: .continuous)
                        .fill(NeumorphicStyle.surfacePressed)
                        .overlay(MonoIcon(icon: .musicNoteList, size: 24, color: NeumorphicStyle.inkMuted.opacity(0.55), lineWidth: 1.7))
                }
                .aspectRatio(1, contentMode: .fill)
                .clipped()
                .clipShape(RoundedRectangle(cornerRadius: 18, style: .continuous))
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ZStack(alignment: .bottomTrailing) {
                ...
                MonoIcon(icon: .chevronRight, size: 11, color: tint, lineWidth: 1.8)
    ...
    var body: some View {
        HStack(spacing: 13) {
            CachedAsyncImage(url: list.coverUrl?.sized(300)) {
                RoundedRectangle(cornerRadius: 17, style: .continuous)
                    .fill(NeumorphicStyle.surfacePressed)
                    .overlay(MonoIcon(icon: .chart, size: 22, color: NeumorphicStyle.inkMuted.opacity(0.6), lineWidth: 1.7))
            }
            .aspectRatio(contentMode: .fill)
            .frame(width: 58, height: 58)
            .clipShape(RoundedRectangle(cornerRadius: 17, style: .continuous))
