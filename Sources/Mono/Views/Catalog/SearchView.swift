...
struct SearchView: View {
    ...
    private func searchTabIcon(_ tab: SearchTab) -> MonoIcon.IconType {
        switch tab {
    ...
    private var availableSearchPlatforms: [MusicSource] {
    ...
    private func platformRows<Item: Identifiable, Row: View>(
        _ items: [Item],
        source: MusicSource,
    ...
    private func albumInfo(from album: SearchAlbum) -> AlbumInfo {
    ...
    private func kcmMVGridCard(mv: KCMMV) -> some View {
        Button {
            selectedKCMMV = mv
            isFocused = false
        } label: {
