...
struct AriaPalette: Equatable {
    ...
    /// 从封面取色派生四色主题；所有颜色均随当前封面动态计算，不写死十六进制值。
            ...
            ZStack {
                RadialGradient(
                    stops: [
                        ...
                        .init(color: .black.opacity(videoMode ? 0.29 : 0.24), location: 0.72),
                        .init(color: .black.opacity(videoMode ? 0.70 : 0.64), location: 1)
                    ],
                    center: .center,
                    startRadius: 0,
