...
struct NeumorphicPlayerLayout: View {
    ...
    private var textColor: Color { .monoTextPrimary }
    private var secondaryTextColor: Color { .monoTextSecondary }
    ...
    private var headerBar: some View {
        HStack {
            neumorphicButton(size: 44) {
                ...
                MonoIcon(icon: .chevronRight, size: 20, color: secondaryTextColor)
        ...
        ZStack {
            ...
            if let song = player.currentSong {
                ...
                RoundedRectangle(cornerRadius: 20)
                    ...
                    .frame(width: size, height: size)
                    .overlay(
                        MonoIcon(icon: .musicNote, size: 60, color: secondaryTextColor)
                    )
            }
        }
    }
    ...
    private var controlsSection: some View {
        HStack(spacing: 0) {
            neumorphicButton(size: 44) {
                ...
                MonoIcon(icon: player.mode.monoIcon, size: 20, color: secondaryTextColor)
            }
            ...
            neumorphicButton(size: 56) {
                ...
                MonoIcon(icon: .previous, size: 26, color: textColor)
            }
            ...
            neumorphicButton(size: 56) {
                ...
                MonoIcon(icon: .next, size: 26, color: textColor)
            }
            ...
            neumorphicButton(size: 44) {
                ...
                MonoIcon(icon: .list, size: 20, color: secondaryTextColor)
            }
        }
    }
        ...
        Button(action: { player.togglePlayPause() }) {
            ZStack {
                ...
                if player.isLoading {
                    ...
                    MonoIcon(icon: player.isPlaying ? .pause : .play, size: 30, color: textColor)
                }
            }
        }
