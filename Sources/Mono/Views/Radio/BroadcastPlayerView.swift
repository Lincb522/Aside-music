...
struct BroadcastPlayerView: View {
    ...
    private var coverPlaceholder: some View {
        RoundedRectangle(cornerRadius: 12, style: .continuous)
            ...
            .overlay(MonoIcon(icon: .radio, size: 24, color: broadcastSecondary, lineWidth: 1.4))
    }
    ...
    private var hairlineTint: Color {
        ...
        return Color.monoSeparator.opacity(0.55)
    }

    private var liveTint: Color {
        SequoiaStyle.isActive ? SequoiaStyle.red : .monoAccentRed
    }

    private var programLiveTint: Color {
        SequoiaStyle.isActive ? SequoiaStyle.green : .monoAccentGreen
    }
