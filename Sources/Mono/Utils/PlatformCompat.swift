...
extension View {
    ...
    @ViewBuilder
    func monoFullScreenCover<Content: View>(
    ...
    @ViewBuilder
    func monoFullScreenCover<Item: Identifiable, Content: View>(
        item: Binding<Item?>,
        onDismiss: (() -> Void)? = nil,
    ...
    @ViewBuilder
    func monoNavigationBarTitleDisplayMode() -> some View {
...
extension ToolbarItemPlacement {
    static var monoTopBarLeading: ToolbarItemPlacement {
        .topBarLeading
    }

    static var monoTopBarTrailing: ToolbarItemPlacement {
        .topBarTrailing
    }
}
