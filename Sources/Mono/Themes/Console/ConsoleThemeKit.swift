...
struct SignalSurfaceBackground: View {
    ...
    var body: some View {
        ...
        shape
            .fill(base)
            .overlay(shape.stroke(line, lineWidth: 0.7))
...
struct SignalScreenBackground: View {
    ...
    var body: some View {
        ...
        shape
            ...
            .overlay(shape.stroke(SignalStyle.separator.opacity(colorScheme == .dark ? 0.72 : 0.78), lineWidth: 0.7))
    }
}
...
private struct SignalModuleInstrument: View {
    ...
    var body: some View {
        ZStack {
            SignalScreenBackground(cornerRadius: 10)
