...
private struct CapsuleMiniPlayerStrip: View {
    ...
    private func control(
        ...
        Button(action: action) {
            MonoIcon(icon: icon, size: size, color: tint, lineWidth: 1.8)
...
private struct CapsuleDockTabBar: View {
    ...
    private static let tabs: [(tab: Tab, outline: MonoIcon.IconType, filled: MonoIcon.IconType, tint: Color)] = [
    ...
    private func tabButton(
        tab: Tab,
        outline: MonoIcon.IconType,
        filled: MonoIcon.IconType,
        tint: Color
    ) -> some View {
